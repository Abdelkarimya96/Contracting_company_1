    ...
    return [
      {
        ...
        description: 'يعد مختبر الصحة العامة في الكويت أحد المرافق المتطورة المخصصة لإجراء الفحوصات الطبية والتحاليل المخبرية. يضم أحدث الأجهزة والتقنيات المخبرية التي تساعد في تحليل العينات بدقة عالية. يقدم المختبر خدمات للكشف عن الأمراض المعدية والمزمنة، مما يساهم في الحفاظ على الصحة العامة. كما يُعتمد عليه في إجراء الأبحاث الطبية المتقدمة.'
      },
      {
        id: 2,
        images: [
        ...
        description: 'مركز باي فرونت الصحي الطبي هو منشأة طبية حديثة تقع في قلب حولي، الكويت. يقدم المركز خدمات الرعاية الصحية الأولية والمتقدمة للمرضى، بما في ذلك التشخيص والعلاج والاستشارات الطبية. يحتوي المركز على طاقم طبي مؤهل وأحدث المعدات الطبية لضمان تقديم أعلى مستويات الرعاية الصحية. كما يضم عيادات تخصصية في مختلف المجالات الطبية.'
      },
      {
        id: 3,
        images: [
        ...
        description: 'يُعتبر مركز صحة المرأة في السالمية مركزًا طبيًا متقدمًا يهتم بصحة النساء ويوفر خدمات شاملة تشمل الفحوصات الدورية، العناية بالحمل، صحة العظام، والتغذية. يضم المركز أحدث التقنيات الطبية وكادرًا متخصصًا من الأطباء والممرضات لضمان تقديم خدمات طبية عالية الجودة. يتميز المركز ببيئة هادئة وخصوصية تامة للمرضى.'
      },
      {
        id: 4,
        images: [
        ...
        description: 'متحف الفنون والثقافة في الفروانية هو مركز ثقافي يهدف إلى تعزيز الفنون والتراث في الكويت. يضم المتحف مجموعة واسعة من المعارض الفنية التي تسلط الضوء على الفنون التقليدية والمعاصرة، إلى جانب ورش العمل والفعاليات الثقافية. يُعتبر المتحف وجهة رئيسية لعشاق الفنون والثقافة من مختلف الأعمار.'
      },
      {
        id: 5,
        images: [
        ...
        description: 'يعد متحف الكويت الوطني من أهم المعالم الثقافية في البلاد، حيث يعرض التاريخ الغني للكويت من خلال مجموعة متميزة من القطع الأثرية والمخطوطات واللوحات التاريخية. يقدم المتحف تجربة فريدة للزوار، حيث يمكنهم استكشاف الحضارات القديمة والتعرف على التراث الثقافي للكويت عبر العصور المختلفة.'
      },
      {
        id: 6,
        images: [
        ...
        description: 'يعد مركز الجهراء الثقافي منصة حيوية للفنون والثقافة في الكويت، حيث يستضيف فعاليات ومعارض وورش عمل ثقافية تهدف إلى تنمية الوعي الثقافي والفني. يتضمن المركز مسرحًا وقاعات عرض ومكتبة، مما يجعله بيئة مثالية للقاء الفنانين والمبدعين.'
      },
      {
        id: 7,
        images: [
